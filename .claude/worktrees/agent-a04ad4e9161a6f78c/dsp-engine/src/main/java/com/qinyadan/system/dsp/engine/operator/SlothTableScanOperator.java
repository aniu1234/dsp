...
import com.qinyadan.system.dsp.storage.api.BaseQuery;
import com.qinyadan.system.dsp.storage.api.QueryContext;
...
public class SlothTableScanOperator extends AbstractOperator<SlothRow> {
    ...
    public void open() {
        ...
        final QueryContext queryContext =
                new QueryContext(BaseQuery.builder().build(), Sets.newHashSet(slothTableEngine.getColumnNames()));
