package com.qinyadan.system.dsp.schema.file.example;
    ...
    public static void main(String[] args) {
        try {
            ...
            info.setProperty(META_MODEL,
                    "/Users/liuzm/workspace/Storage/schema/file-schema/src/main/resources/file.json");
            ...
            for (int i = 0; i < 1; i++) {
                ResultSet r = statement.executeQuery("select TABLE1.ID, TABLE1.NAME, TABLE2.ADDR from csv.T1 TABLE1 "
                        + "INNER JOIN JSON.T1 TABLE2 on TABLE1.ID = TABLE2.ID where TABLE1.ID + 1 > 2");
