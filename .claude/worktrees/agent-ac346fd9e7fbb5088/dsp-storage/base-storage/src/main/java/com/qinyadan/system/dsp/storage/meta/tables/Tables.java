 ...
 */
package com.qinyadan.system.dsp.storage.meta.tables;


import com.qinyadan.system.dsp.storage.meta.Sloth;
import com.qinyadan.system.dsp.storage.meta.tables.records.TablesRecord;
import org.jooq.*;
...
public class Tables extends TableImpl<TablesRecord> {
    ...
    private static final long serialVersionUID = -365015364;
    ...
    /**
     * The column <code>sloth.tables.TABLE_SHARD</code>. shard数目
     */
    public final TableField<TablesRecord, Integer> TABLE_SHARD = createField(DSL.name("TABLE_SHARD"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("1", org.jooq.impl.SQLDataType.INTEGER)), this, "shard数目");
    ...
    public <O extends org.jooq.Record> Tables(Table<O> child, ForeignKey<O, TablesRecord> key) {
