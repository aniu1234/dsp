package com.qinyadan.system.dsp.core.data.value;
...
public class Value implements Comparable<Value> {
    ...
    public String stringValue() {
        ...
        if (getType() == DataTypes.TIMESTAMP || getType() == DataTypes.TIMESTAMPZ) {
            return TimeUtils.formatTimestamp(new java.util.Date(longValue()));
        }
