...
public class NettyConnectionHandler extends ChannelInboundHandlerAdapter {
    ...
    private boolean sendAuthencationPackage(Channel channel) {
        ...
        // MySQL auth-plugin data is split by NUL terminators in the greeting packet.
        // Use printable, non-zero bytes so clients never truncate the random challenge.
        for (int i = 0; i < challenge.length; i++) {
            challenge[i] = (byte) (33 + secureRandom.nextInt(94));
        }
